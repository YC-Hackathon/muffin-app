...
// Crazy Flutter Particles Animation Component
...
// Crazy Typewriter Text Effect Component
...
export default function Home() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-[#0B0C0A] to-[#141311]">
      {/* Crazy Flutter Particles Background */}
      <FlutterParticles />
      
      {/* Multiple Crazy Typewriter Text Effects */}
...
function Hero() {
  return (
    <section className="mx-auto max-w-5xl px-6 py-24 md:py-32">
      {/* Crazy Animated Logo with Top-Down Spotlight */}
      <div className="mb-8 flex justify-center">
        <div className="relative group">
          ...
          <Image
            src={muffinLogo}
            alt="Flutter Agent Logo"
            width={80}
            height={80}
            className="rounded-lg relative z-10 transform group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 hover:animate-bounce"
          />
      ...
      <div className="mb-6 inline-flex items-center gap-2 rounded-md border border-[rgba(242,241,238,0.08)] bg-[rgba(20,19,17,0.6)] px-3 py-1.5 text-lg text-[#B6B3AD]">
        <span className="inline-block h-1.5 w-1.5 rounded-sm bg-[#ff4000]" />
        Focused. Quiet. Reliable.
      </div>
      {/* Crazy Intent-to-Code Transformation Animation */}
              <div className="relative mb-8">
          <h1 className="text-balance text-5xl font-semibold tracking-tight text-[#F2F1EE] sm:text-6xl md:text-7xl relative z-10">
      ...
      <p className="mt-4 max-w-2xl text-pretty text-xl leading-relaxed text-[#B6B3AD]">
      ...
      <div className="mt-8 flex items-center gap-4">
        ...
        <a
          href="#features"
          className="group inline-flex items-center text-lg text-[#B6B3AD] hover:text-[#ff4000] transition-all duration-300 hover:scale-105"
        >
          <span className="mr-2">Learn more</span>
          <span className="text-[#ff4000] opacity-0 group-hover:opacity-100 transform -translate-x-2 group-hover:translate-x-0 transition-all duration-300">{"⚡"}</span>
        </a>
      </div>
    </section>
  );
...
function Card({ title, desc }: { title: string; desc: string }) {
  ...
  return (
    <div
      ...
      className="relative overflow-hidden rounded-lg border border-[rgba(242,241,238,0.12)] bg-[rgba(18,17,15,0.6)] p-5 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-[#ff4000]/25 group hover:border-[#ff4000]"
    >
  ...
  return (
    <section className="mx-auto max-w-5xl px-6 py-16">
      {/* <div className="mb-6 flex flex-wrap items-center gap-2">
        <span className="rounded-md border border-[rgba(242,241,238,0.08)] bg-[rgba(20,19,17,0.6)] px-2.5 py-1 text-base text-[#B6B3AD]">
          YC Hackathon Finalist
        </span>
        <span className="rounded-md border border-[rgba(242,241,238,0.08)] bg-[rgba(20,19,17,0.6)] px-2.5 py-1 text-base text-[#B6B3AD]">
          Built in 24 hours
        </span>
      </div> */}
      {/* Request Access Button with Same Animation Style */}
      <a
        href="#"
        className="group relative inline-flex items-center rounded-md border border-[rgba(242,241,238,0.12)] bg-[rgba(24,23,21,0.7)] px-5 py-2.5 text-lg font-medium text-[#F2F1EE] transition-all duration-300 hover:border-[#ff4000] hover:bg-[rgba(24,23,21,0.85)] hover:scale-105 hover:shadow-lg hover:shadow-[#ff4000]/25"
      >
  ...
  return (
    <footer className="mx-auto max-w-5xl px-6 pb-16">
      ...
      <div className="mt-6 flex items-center justify-between text-base text-[#8E8B85]">
        <span>© {new Date().getFullYear()} Flutter Agent</span>
        <div className="flex items-center gap-4">
          <a href="#" className="hover:text-[#ff4000] transition-colors">
            Docs
          </a>
          <a href="#" className="hover:text-[#ff4000] transition-colors">
            GitHub
